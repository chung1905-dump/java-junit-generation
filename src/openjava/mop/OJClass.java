...
public class OJClass implements OJMember {
	...
	public OJClass primitiveWrapper() {
		...
		if (this == OJSystem.BYTE)
			return OJClass.forClass(Byte.class);
		if (this == OJSystem.CHAR)
			return OJClass.forClass(Character.class);
		if (this == OJSystem.SHORT)
			return OJClass.forClass(Short.class);
		if (this == OJSystem.INT)
			return OJClass.forClass(Integer.class);
	...
	public OJClass unwrappedPrimitive() {
		if (this == OJClass.forClass(Boolean.class))
			return OJSystem.BOOLEAN;
		if (this == OJClass.forClass(Byte.class))
			return OJSystem.BYTE;
		if (this == OJClass.forClass(Character.class))
			return OJSystem.CHAR;
		if (this == OJClass.forClass(Short.class))
			return OJSystem.SHORT;
		if (this == OJClass.forClass(Integer.class))
			return OJSystem.INT;
		if (this == OJClass.forClass(Long.class))
			return OJSystem.LONG;
		if (this == OJClass.forClass(Float.class))
			return OJSystem.FLOAT;
		if (this == OJClass.forClass(Double.class))
